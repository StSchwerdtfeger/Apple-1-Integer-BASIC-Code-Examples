...
Now just type in the code by hand. Note that the Apple 1 does not have a BACKSPACE function! Either create a syntax error in BASIC and rewrite a line or use Ctrl + H to hard reset and Ctrl + R to reset. Some of the endless loops in the code examples can be stopped via pressing ESC.
